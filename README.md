...
ZBX_BRANCH=kylin_v10_zabbix_7.0.x_mysql
...
```
tar -zxvf zabbix-kylin_v10_zabbix_7.0.x_mysql.tar.gz
cd zabbix-kylin_v10_zabbix_7.0.x_mysql
...
**将grafana界面设置成中文**
![](https://gitcode.com/fantasywith/zabbix/-/raw/rocky_8_zabbix_6.0.x_mysql/vx_images/2cc17fdd154217656975030bc6636523.png)

**启用zabbix插件
![](https://gitcode.com/fantasywith/zabbix/-/raw/rocky_8_zabbix_6.0.x_mysql/vx_images/844a584f0789fc28205b2b5a8302938c.png)

**连接zabbix数据库插件**
![](https://gitcode.com/fantasywith/zabbix/-/raw/rocky_8_zabbix_6.0.x_mysql/vx_images/c87b39af3050dac2ecb62c7365bc7a7b.png)

**新建zabbix数据库连接**
`https://zabbix-web-nginx-mysql:8443/api_jsonrpc.php`

![](https://gitcode.com/fantasywith/zabbix/-/raw/rocky_8_zabbix_6.0.x_mysql/vx_images/c68d9dbf98134214aa759dd25bbfbb2e.png)

**输入正确的用户名密码**
`Admin/zabbix`

![](https://gitcode.com/fantasywith/zabbix/-/raw/rocky_8_zabbix_6.0.x_mysql/vx_images/aa5fd658ee04a9dd7687e459b3064dbe.png)
...
URL为http://IP:3100
![在这里插入图片描述](https://gitcode.com/fantasywith/zabbix/-/raw/rocky_8_zabbix_6.0.x_mysql/vx_images/c469826e35f6d0735418cbb9ca008b22.png)
