...
[2026-2-26 18:40:21]
更新 - 新增更加LLDP自动发现网络拓扑图
更新 - 拓扑图配置支持导出到Excel，编辑后支持再倒回来
更新 - switch图标新增SNMP相关配置用于支持自动更新专属标签以及发现LLDP邻居关系

[2026-1-8 21:07:33]
更新 - 新增交换机配置批量备份功能

[2026-1-5 20:44:49]
更新 - 重写保存加载逻辑配置文件现在更符合json逻辑
更新 - 添加了新功能能够对文本框的文本按文字分片设置颜色
更新 - 支持为连线设置颜色、保存连线颜色、加载连线颜色
[2025-12-24 19:36:03]
更新 - 新增连线助手，接近连线高亮连线
修复 - 解决无法连线的bug
[2025-12-11 12:53:53]
...
[2025-11-27 19:27:19]
版本 - v1.0.8
修复 - 解决了Ctrl + 点击鼠标左键无法多选的问题
[2025-11-27 19:27:19]
版本 - v1.0.7
更新 - 支持图形自动对齐功能
更新 - 支持按住Ctrl + 鼠标左键框选多图形
更新 - 支持复选多图形对齐功能
[2025-11-28 10:50:34]
版本 - v1.0.6
修复 - 解决了点击空白处焦点不消失问题
修复 - 解决了查找窗口不跟随主窗口一起推出问题
[2025-11-27 19:27:19]
版本 - v1.0.5
更新 - 支持查找高亮文本快捷键是Ctrl + F
更新 - 支持按住Ctrl + 鼠标滑轮画布放大缩小1%-3000%
更新 - 支持按住Shift + 鼠标滑轮画布左右横移动
更新 - 支持按住鼠标左键 + 滑动鼠标变换画布位置
更新 - 画布连线抗锯齿
[2025-11-12 11:52:30]
更新 - 更新支持将文本颜色设置为红、蓝灯颜色并保存加载
修复 - 修复了右键设置ssh叉掉再添加ssh图标无法添加问题
[2024-1-8 13:31:17] 网络拓扑图绘制与运维管理工具

![](vx_images/3284e89c80754a12a9dbcf7d26cd7526.png)

`感谢打赏`  
  
| 微信                                                                                        | 支付宝                                                                                        |  
|-------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|  
| ![微信打赏](vx_images/thanks_wx.jpg) | ![支付宝](vx_images/thanks_zfb.jpg) |  
