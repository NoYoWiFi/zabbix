...
ZBX_BRANCH=rocky_8_zabbix_6.0.x_mysql
...
```
3. 执行命令全自动安装zabbix-proxy[按需安装server端可选安装]
```
tar -zxvf zabbix-rocky_8_zabbix_6.0.x_mysql.tar.gz
cd zabbix-rocky_8_zabbix_6.0.x_mysql
...
**将grafana界面设置成中文**
![](https://i-blog.csdnimg.cn/blog_migrate/3656e958c60a3843995e70323ddd9941.png)

**启用zabbix插件
![](https://i-blog.csdnimg.cn/blog_migrate/33ea10493d53c281460a9bfdfc16188e.png)

**连接zabbix数据库插件**
![](https://i-blog.csdnimg.cn/blog_migrate/827f8b9bd3c8b40589363550ea11e666.png)

**新建zabbix数据库连接**
`https://zabbix-web-nginx-mysql:8443/api_jsonrpc.php`

![](https://i-blog.csdnimg.cn/blog_migrate/6e15129b44fdd146afb640f306c7b033.png)

**输入正确的用户名密码**
`Admin/zabbix`

![](https://i-blog.csdnimg.cn/blog_migrate/61af2ae8d96841548c764a839fb91486.png)
...
URL为http://IP:3100
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6747376b00d6d3abbb4df0eae1a3c7df.png)

`交流群`  
  
| zabbix-答疑群                                                                                                | zabbix-汉化群                                                                                                  |  
|-----------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|  
| ![微信打赏](https://i-blog.csdnimg.cn/blog_migrate/cd96595c6f5aaa1d708de00f5b67a1c2.png) | ![微信打赏](https://i-blog.csdnimg.cn/blog_migrate/f8fce96f9ac043f8cafd80f08bc09951.png) |  
